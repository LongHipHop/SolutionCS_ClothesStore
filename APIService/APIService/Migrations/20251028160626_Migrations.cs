    ...
    public partial class Migrations : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Vinh Long", new DateOnly(2025, 10, 1), new DateOnly(2025, 10, 28), "truongtranlong23@gmail.com", "Truong Tran Long", "Male", null, "$2a$12$cVw6vAlKHuxIFsz32ElSnOmMjjoeFpyIbRHZOfrim7nAgz0UbImI6", "0868984121", null, null, 1, "Active", 0, new DateOnly(2025, 10, 28) },
                    { 2, "Vinh Long", new DateOnly(2025, 10, 1), new DateOnly(2025, 10, 28), "longttce171365@fpt.edu.vn", "Tran Thi B", "Male", null, "$2a$12$cVw6vAlKHuxIFsz32ElSnOmMjjoeFpyIbRHZOfrim7nAgz0UbImI6", "0868984122", null, null, 4, "Active", 0, new DateOnly(2025, 10, 28) },
                    { 3, "Vinh Long", new DateOnly(2025, 10, 1), new DateOnly(2025, 10, 28), "customer@shop.com", "Phạm Văn C", "Male", null, "$2a$12$cVw6vAlKHuxIFsz32ElSnOmMjjoeFpyIbRHZOfrim7nAgz0UbImI6", "0868984123", null, null, 5, "Active", 0, new DateOnly(2025, 10, 28) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 3, new DateTime(2025, 10, 28, 23, 6, 25, 315, DateTimeKind.Local).AddTicks(6699) });

            migrationBuilder.InsertData(
                table: "Orders",
                columns: new[] { "Id", "AccountId", "Note", "OrderDate", "PaymentMethod", "ShippingAddress", "Status", "TotalPrice" },
                values: new object[] { 1, 3, "First order", new DateTime(2025, 10, 28, 23, 6, 25, 315, DateTimeKind.Local).AddTicks(6839), "COD", "123 Main St", "Pending", 500000m });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 500000m, 1, new DateTime(2025, 10, 28, 23, 6, 25, 315, DateTimeKind.Local).AddTicks(6747), "COD", "Pending" },
                    { 2, 500000m, 1, new DateTime(2025, 10, 28, 23, 6, 25, 315, DateTimeKind.Local).AddTicks(6750), "Bank Transfer", "Completed" }
                });
